...
export default class Login extends Component {
  ...
  Dangnhap() {
    if(this.state.info.email == '' || this.state.info.money == '' || this.state.info.type == '' || this.state.info.typeMoney == ''){
      Alert.alert(
        "Alert Title",
    ...
    this.itemRef.ref("History").push(this.state.info);
          ...
          <View style={styles.down}>
            ...
            <View style={styles.rowInfo}>
              ...
              <View style={styles.textInputContainer}>
                ...
                <TouchableOpacity
                  style={{ flex: 4, alignItems: 'flex-end', justifyContent: 'center'}}
                  onPress={() => {
                    this.showDatePicker();
                  }}
                >
